  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center p-0 relative overflow-x-hidden pb-24">
      ...
      <div className="w-full max-w-[420px] flex flex-col gap-3.5 z-10 animate-in fade-in slide-in-from-bottom-2 duration-500 px-3">
        ...
        <div className="mt-4 h-[56px] bg-white rounded-lg shadow-sm flex items-center justify-between px-3.5 border border-gray-100">
          <Button 
            variant="ghost" 
            size="icon" 
            className="w-9 h-9 hover:bg-gray-50 text-gray-400"
            onClick={() => router.back()}
          >
        ...
        <div className="w-full bg-white rounded-lg border border-gray-100 shadow-sm p-3.5 flex items-center gap-3.5">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[9px] text-gray-400 font-bold uppercase">ইনভয়েস আইডিঃ <span className="text-gray-500">SSICBT940147</span></p>
          </div>
        </div>

        {/* Amount Bar */}
        <div className="w-full bg-white rounded-lg border border-gray-100 shadow-sm px-4 py-3 flex items-center">
          <span className="text-base font-bold text-[#5F6E8C]">৳145.00</span>
        </div>

        {/* Instruction & Input Box - Smaller & Rounded */}
        <div className={`w-full rounded-xl p-5 ${config.boxBg} text-white shadow-md mb-4`}>
          <h2 className="text-xs font-bold mb-3.5 text-center">ট্রানজেকশন আইডি দিন</h2>
          ...
          <div className="relative mb-5">
            <Input 
              ...
              className="bg-white border-none text-gray-700 placeholder:text-gray-300 h-9 rounded-md text-center text-[11px] font-bold focus-visible:ring-0"
            />
          </div>

          <div className="space-y-3 text-[10px] font-bold leading-relaxed">
            ...
            <div className="flex items-start gap-2 pb-2.5 border-b border-white/10">
              ...
              <div className="flex flex-col gap-1.5">
                <p>প্রাপক নম্বর হিসেবে এই নম্বরটি লিখুনঃ <span className="text-yellow-400 text-xs tracking-wide">{config.number}</span></p>
                <button 
                  onClick={copyNumber} 
                ...
                >
                  ...
                  <span className="text-[8px] font-bold uppercase">Copy</span>
                </button>
              </div>
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 flex justify-center z-50 pointer-events-none">
        <div className="w-full max-w-[420px] pointer-events-auto">
          <Button 
            className={`w-full h-[56px] rounded-t-xl rounded-b-none text-white font-bold text-xs tracking-widest transition-all active:scale-[0.99] ${config.boxBg} hover:brightness-105 shadow-md`}
          >
            VERIFY
          </Button>
        </div>
